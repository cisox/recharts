...
var parseScale = function parseScale(axis, chartType) {
  ...
  if (scale === 'auto') {
    ...
    if (type === 'category' && chartType && (chartType.indexOf('LineChart') >= 0 || chartType.indexOf('AreaChart') >= 0 || chartType.indexOf('DistributionChart') >= 0 || chartType.indexOf('ComposedChart') >= 0)) {
      return {
