...
class Distribution extends PureComponent {
  ...
  renderDistributionStatically(points, baseLine, needClip, clipPathId) {
  ...
  renderDistributionWithAnimation(needClip, clipPathId) {
            ...
            return (
              <Layer>
                ...
                <Layer clipPath={`url(#animationClipPath-${clipPathId})`}>
                  {this.renderDistributionStatically(points, baseLine, needClip, clipPathId)}
                </Layer>
              </Layer>
            );
          }
  ...
  renderDistribution(needClip, clipPathId) {
    ...
    if (isAnimationActive && points && points.length &&
      ...
      return this.renderDistributionWithAnimation(needClip, clipPathId);
    }

    return this.renderDistributionStatically(points, baseLine, needClip, clipPathId);
  }
