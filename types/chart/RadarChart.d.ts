...
declare const _default: {
    new (props: import("./generateCategoricalChart").CategoricalChartProps): {
        ...
        UNSAFE_componentWillReceiveProps(nextProps: import("./generateCategoricalChart").CategoricalChartProps): void;
        componentWillUnmount(): void;
        cancelThrottledTriggerAfterMouseMove(): void;
        getAxisMap(props: import("./generateCategoricalChart").CategoricalChartProps, { axisType, AxisComp, graphicalItems, stackGroups, dataStartIndex, dataEndIndex }: any): {};
        ...
        getFormatItems(props: import("./generateCategoricalChart").CategoricalChartProps, currentState: any): any[];
        ...
        tooltipTicksGenerator: (axisMap: any) => {
            tooltipTicks: import("../util/types").TickItem[];
            orderedTooltipTicks: import("../util/types").TickItem[];
            tooltipAxis: import("../util/types").BaseAxisProps;
        ...
        componentDidUpdate?(prevProps: Readonly<import("./generateCategoricalChart").CategoricalChartProps>, prevState: Readonly<import("./generateCategoricalChart").CategoricalChartState>, snapshot?: any): void;
    ...
    createDefaultState: (props: import("./generateCategoricalChart").CategoricalChartProps) => import("./generateCategoricalChart").CategoricalChartState;
    hasBar: (graphicalItems: any[]) => boolean | any[];
    getDisplayedData: (props: import("./generateCategoricalChart").CategoricalChartProps, { graphicalItems, dataStartIndex, dataEndIndex }: any, item?: any) => any[];
    getAxisNameByLayout(layout: import("../util/types").LayoutType): {
