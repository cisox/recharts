...
declare type DistributionDot = ReactElement<SVGElement> | ((props: any) => SVGElement) | DotProps | boolean;
...
declare type Props = PresentationAttributes<SVGElement> & DistributionProps;
interface State {
...
declare class Distribution extends PureComponent<Props, State> {
    ...
    static getBaseValue: (props: Props, xAxis: Pick<XAxisProps, "height" | "name" | "type" | "width" | "orientation" | "dataKey" | "ticks" | "hide" | "tick" | "tickCount" | "axisLine" | "tickLine" | "tickSize" | "tickFormatter" | "allowDataOverflow" | "allowDuplicatedCategory" | "allowDecimals" | "domain" | "unit" | "axisType" | "range" | "AxisComp" | "padding" | "xAxisId" | "mirror" | "minTickGap" | "interval" | "reversed"> & {
        scale: D3Scale<React.ReactText>;
    }, yAxis: Pick<YAxisProps, "height" | "name" | "type" | "width" | "orientation" | "dataKey" | "ticks" | "hide" | "tick" | "tickCount" | "axisLine" | "tickLine" | "tickSize" | "tickFormatter" | "allowDataOverflow" | "allowDuplicatedCategory" | "allowDecimals" | "domain" | "unit" | "axisType" | "range" | "AxisComp" | "padding" | "mirror" | "minTickGap" | "interval" | "reversed" | "yAxisId"> & {
        scale: D3Scale<React.ReactText>;
    }) => number;
    static getComposedData: ({ props, xAxis, yAxis, xAxisTicks, yAxisTicks, bandSize, dataKey, stackedData, dataStartIndex, displayedData, offset, }: {
        ...
        item: Distribution;
        bandSize: number;
        xAxis: Pick<XAxisProps, "height" | "name" | "type" | "width" | "orientation" | "dataKey" | "ticks" | "hide" | "tick" | "tickCount" | "axisLine" | "tickLine" | "tickSize" | "tickFormatter" | "allowDataOverflow" | "allowDuplicatedCategory" | "allowDecimals" | "domain" | "unit" | "axisType" | "range" | "AxisComp" | "padding" | "xAxisId" | "mirror" | "minTickGap" | "interval" | "reversed"> & {
            scale: D3Scale<React.ReactText>;
        };
        yAxis: Pick<YAxisProps, "height" | "name" | "type" | "width" | "orientation" | "dataKey" | "ticks" | "hide" | "tick" | "tickCount" | "axisLine" | "tickLine" | "tickSize" | "tickFormatter" | "allowDataOverflow" | "allowDuplicatedCategory" | "allowDecimals" | "domain" | "unit" | "axisType" | "range" | "AxisComp" | "padding" | "mirror" | "minTickGap" | "interval" | "reversed" | "yAxisId"> & {
            scale: D3Scale<React.ReactText>;
    ...
    static renderDotItem: (option: DistributionDot, props: any) => SVGElement | JSX.Element;
    state: State;
    UNSAFE_componentWillReceiveProps(nextProps: Props): void;
    id: string;
    cachePrevData: (points: DistributionPointItem[], baseLine: number | Coordinate[]) => void;
    ...
    renderAreaStatically(points: DistributionPointItem[], baseLine: Props['baseLine'], needClip: boolean, clipPathId: string): JSX.Element;
